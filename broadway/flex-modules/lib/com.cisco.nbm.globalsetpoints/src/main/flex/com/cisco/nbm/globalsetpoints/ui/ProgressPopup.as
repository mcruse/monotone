package com.cisco.nbm.globalsetpoints.ui
{
	...
	public class ProgressPopup extends ProgressPopupBase
	{
		...
		public static function show(label:String=null, panelParent:DisplayObject=null):ProgressPopup
		{
			...
			PopUpManager.addPopUp(panel, panelParent, true);
   			...
   			if(label == null) label = "Please wait....";
