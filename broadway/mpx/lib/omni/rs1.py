...
License.
"""
# This code was generated from File: mpx/lib/omni/rs1.proto .
...
class readmeterreq(gd.BaseGDClass):
    def __init__(self):
        ...
        self.items.append(x)
        #
        x = gd.IntItem(name="di_b1", width=1, value=0x43, packspec="<B", ispack=1, widthispack=0, type="uint8")
        self.items.append(x)
        #
        x = gd.IntItem(name="di_b2", width=1, value=0xC3, packspec="<B", ispack=1, widthispack=0, type="uint8")
        self.items.append(x)
        #
...
class readmeterres(gd.BaseGDClass):
    def __init__(self):
        ...
        self.items.append(x)
        #
        x = gd.IntItem(name="len", width=1, value=0x06, packspec="<B", ispack=1, widthispack=0, type="uint8")
        self.items.append(x)
        #
        ...
        self.items.append(x)
        #
        x = gd.BufferItem(name="data", isfixedwidth=1, width=4, ispack=0, widthispack=0, type="fbuffer")
        self.items.append(x)
        #
        x = gd.IntItem(name="cs", width=1, packspec="<B", ispack=1, widthispack=0, type="uint8")
        self.items.append(x)
