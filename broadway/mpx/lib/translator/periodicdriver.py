...
"""
##
# @depricated Moved implementation to mpx.lib.driver.PeriodicDriver.

from mpx.lib import deprecated as _deprecated
from mpx.lib.driver import PeriodicDriver as _PeriodicDriver

##
# @depricated Use mpx.lib.driver.PeriodicDriver.
class PeriodicDriver(_PeriodicDriver):
    ##
    # @deprecated Use mpx.lib.driver.PeriodicDriver.
    def __init__(self):
